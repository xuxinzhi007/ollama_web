...
- ⌨️ **现代化菜单**：支持箭头键选择（安装 questionary 后自动启用）
...
- ✅ 相关功能集中在一起
- ✅ 新手友好，一看就懂
- 🆕 **支持箭头键选择**（需安装 questionary）

### ⌨️ 现代化菜单体验 🆕

**安装 questionary 后，可使用箭头键选择：**

```bash
pip install questionary  # 安装（已在 requirements.txt 中）
./train --menu           # 享受箭头选择体验
```
...
- ✅ 无需输入数字，直接箭头选择
- ✅ 当前选项高亮显示
- ✅ macOS 和 Windows 完美支持
- ✅ 未安装会自动降级到数字输入

详细说明：`INSTALL_QUESTIONARY.md`
